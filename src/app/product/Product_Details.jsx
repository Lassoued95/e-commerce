...
const Product_Details = () => {
    ...
    const handleRemoveFromCart = (productId) => {
        setCart((prevCart) => {
            const index = prevCart.findIndex(item => item.id === productId); // Trouver la première occurrence
            if (index !== -1) {
                const updatedCart = [...prevCart];
                updatedCart.splice(index, 1); // Supprime une seule occurrence
                return updatedCart;
            }
            return prevCart;
        });
    ...
    return (
        <div className="relative flex justify-center items-center min-h-screen bg-gradient-to-b from-gray-100 to-white p-6">
            
            <div className="bg-white shadow-lg rounded-xl p-8 flex flex-col md:flex-row max-w-3xl w-full mx-4">
            ...
            {/* Icône de panier en bas à droite */}
